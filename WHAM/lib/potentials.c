...
static PyObject *__pyx_pw_4WHAM_3lib_10potentials_1harmonic(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_xstar)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("harmonic", 1, 2, 2, 1); __PYX_ERR(0, 4, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "harmonic") < 0)) __PYX_ERR(0, 4, __pyx_L3_error)
      }
  ...
  __Pyx_RaiseArgtupleInvalid("harmonic", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 4, __pyx_L3_error)
  __pyx_L3_error:;
...
/* Python wrapper */
static PyObject *__pyx_pw_4WHAM_3lib_10potentials_8harmonic_1harmonic_potential(PyObject *__pyx_self, PyObject *__pyx_v_x); /*proto*/
static PyMethodDef __pyx_mdef_4WHAM_3lib_10potentials_8harmonic_1harmonic_potential = {"harmonic_potential", (PyCFunction)__pyx_pw_4WHAM_3lib_10potentials_8harmonic_1harmonic_potential, METH_O, 0};
static PyObject *__pyx_pw_4WHAM_3lib_10potentials_8harmonic_1harmonic_potential(PyObject *__pyx_self, PyObject *__pyx_v_x) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("harmonic_potential (wrapper)", 0);
  __pyx_r = __pyx_pf_4WHAM_3lib_10potentials_8harmonic_harmonic_potential(__pyx_self, ((PyObject *)__pyx_v_x));
...
static PyObject *__pyx_pf_4WHAM_3lib_10potentials_8harmonic_harmonic_potential(PyObject *__pyx_self, PyObject *__pyx_v_x) {
 ...
 */
  ...
  if (unlikely(!__pyx_cur_scope->__pyx_v_kappa)) { __Pyx_RaiseClosureNameError("kappa"); __PYX_ERR(0, 14, __pyx_L1_error) }
  __pyx_t_1 = __Pyx_PyNumber_Divide(__pyx_cur_scope->__pyx_v_kappa, __pyx_int_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (unlikely(!__pyx_cur_scope->__pyx_v_xstar)) { __Pyx_RaiseClosureNameError("xstar"); __PYX_ERR(0, 14, __pyx_L1_error) }
  __pyx_t_2 = PyNumber_Subtract(__pyx_v_x, __pyx_cur_scope->__pyx_v_xstar); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = PyNumber_Power(__pyx_t_2, __pyx_int_2, Py_None); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 14, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_AddTraceback("WHAM.lib.potentials.harmonic.harmonic_potential", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
 ...
 *     return harmonic_potential
 */
  __pyx_t_1 = __Pyx_CyFunction_New(&__pyx_mdef_4WHAM_3lib_10potentials_8harmonic_1harmonic_potential, 0, __pyx_n_s_harmonic_locals_harmonic_potenti, ((PyObject*)__pyx_cur_scope), __pyx_n_s_WHAM_lib_potentials, __pyx_d, ((PyObject *)__pyx_codeobj__2)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_cur_scope->__pyx_v_phi)) { __Pyx_RaiseClosureNameError("phi"); __PYX_ERR(0, 27, __pyx_L1_error) }
  __pyx_t_1 = PyNumber_Multiply(__pyx_cur_scope->__pyx_v_phi, __pyx_v_x); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
 ...
 *     return harmonic_potential
 */
  __pyx_t_1 = __Pyx_CyFunction_New(&__pyx_mdef_4WHAM_3lib_10potentials_6linear_1harmonic_potential, 0, __pyx_n_s_linear_locals_harmonic_potential, ((PyObject*)__pyx_cur_scope), __pyx_n_s_WHAM_lib_potentials, __pyx_d, ((PyObject *)__pyx_codeobj__4)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_harmonic_potential = __pyx_t_1;
  __pyx_t_1 = 0;
 ...
 *     return harmonic_potential
 */
  __pyx_tuple__3 = PyTuple_Pack(1, __pyx_n_s_x); if (unlikely(!__pyx_tuple__3)) __PYX_ERR(0, 26, __pyx_L1_error)
...
static int __Pyx_modinit_type_init_code(void) {
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_4WHAM_3lib_10potentials___pyx_scope_struct__harmonic) < 0) __PYX_ERR(0, 4, __pyx_L1_error)
  #if PY_VERSION_HEX < 0x030800B1
  ...
  if (PyType_Ready(&__pyx_type_4WHAM_3lib_10potentials___pyx_scope_struct_1_linear) < 0) __PYX_ERR(0, 18, __pyx_L1_error)
  #if PY_VERSION_HEX < 0x030800B1
 ...
 *     Returns umbrella potential
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4WHAM_3lib_10potentials_3linear, NULL, __pyx_n_s_WHAM_lib_potentials); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_linear, __pyx_t_1) < 0) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
